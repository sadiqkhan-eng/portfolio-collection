    ...
    <section id="home" className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <h1 className="text-5xl md:text-6xl lg:text-3xl font-bold text-foreground mb-6 leading-tight">
          ...
          >
            I design and develop fast, scalable, and responsive web apps using Next.js, Tailwind CSS, and modern technologies.
          </motion.p>
